...
public class SoccerActivity9 extends AppCompatActivity {
    String player_name;
    String naming;
    ...
    int player1_flag = 0, player2_flag = 0, player3_flag = 0, player4_flag = 0, player5_flag = 0, player6_flag = 1,
            player7_flag = 1, player8_flag = 1, player9_flag = 2, player10_flag = 2, player11_flag = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soccer7);

        tv_name = (TextView) findViewById(R.id.tv8_name);
        tv_name.setText(a.getName());

        mutebutton = (ImageView) findViewById(R.id.muted5);
        mutebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (flaged == 0) {
                    stopService(new Intent(SoccerActivity9.this, MusicService.class));
                    flaged = 1;
                    mutebutton.setImageDrawable(getResources().getDrawable(R.drawable.notmute, getApplicationContext().getTheme()));
                } else {
                    startService(new Intent(SoccerActivity9.this, MusicService.class));
                    flaged = 0;
        ...
        name = a.tag;
        iv_share = (ImageView) findViewById(R.id.share8);
        ...
        iv_player1 = (ImageView) findViewById(R.id.iv8_player1);
        iv_player1.setOnClickListener(new MyListener());
        iv_player1.setOnTouchListener(new DraggingListener());

        iv_player2 = (ImageView) findViewById(R.id.iv8_player2);
        iv_player2.setOnClickListener(new MyListener());
        iv_player2.setOnTouchListener(new DraggingListener());

        iv_player3 = (ImageView) findViewById(R.id.iv8_player3);
        iv_player3.setOnClickListener(new MyListener());
        iv_player3.setOnTouchListener(new DraggingListener());

        iv_player4 = (ImageView) findViewById(R.id.iv8_player4);
        iv_player4.setOnClickListener(new MyListener());
        iv_player4.setOnTouchListener(new DraggingListener());

        iv_player5 = (ImageView) findViewById(R.id.iv8_player5);
        iv_player5.setOnClickListener(new MyListener());
        iv_player5.setOnTouchListener(new DraggingListener());

        iv_player6 = (ImageView) findViewById(R.id.iv8_player6);
        iv_player6.setOnClickListener(new MyListener());
        iv_player6.setOnTouchListener(new DraggingListener());

        iv_player7 = (ImageView) findViewById(R.id.iv8_player7);
        iv_player7.setOnClickListener(new MyListener());
        iv_player7.setOnTouchListener(new DraggingListener());

        iv_player8 = (ImageView) findViewById(R.id.iv8_player8);
        iv_player8.setOnClickListener(new MyListener());
        iv_player8.setOnTouchListener(new DraggingListener());

        iv_player9 = (ImageView) findViewById(R.id.iv8_player9);
        iv_player9.setOnClickListener(new MyListener());
        iv_player9.setOnTouchListener(new DraggingListener());

        iv_player10 = (ImageView) findViewById(R.id.iv8_player10);
        iv_player10.setOnClickListener(new MyListener());
        iv_player10.setOnTouchListener(new DraggingListener());

        iv_player11 = (ImageView) findViewById(R.id.iv8_player11);
        iv_player11.setOnClickListener(new MyListener());
        iv_player11.setOnTouchListener(new DraggingListener());


        tv_player1 = (TextView) findViewById(R.id.tv8_player1);
        tv_player2 = (TextView) findViewById(R.id.tv8_player2);
        tv_player3 = (TextView) findViewById(R.id.tv8_player3);
        tv_player4 = (TextView) findViewById(R.id.tv8_player4);
        tv_player5 = (TextView) findViewById(R.id.tv8_player5);
        tv_player6 = (TextView) findViewById(R.id.tv8_player6);
        tv_player7 = (TextView) findViewById(R.id.tv8_player7);
        tv_player8 = (TextView) findViewById(R.id.tv8_player8);
        tv_player9 = (TextView) findViewById(R.id.tv8_player9);
        tv_player10 = (TextView) findViewById(R.id.tv8_player10);
        tv_player11 = (TextView) findViewById(R.id.tv8_player11);
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                for (int i = 0; i < imageViewList.size(); i++) {
                    ...
                    if ((v.getX() - imageViewList.get(i).getX()) * (v.getX() - imageViewList.get(i).getX()) +
                        ...
                        Toast.makeText(SoccerActivity9.this, "변경완료", Toast.LENGTH_SHORT).show();
    ...
    class MyListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (System.currentTimeMillis() <= btnPressTime + 1000) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(SoccerActivity9.this);
