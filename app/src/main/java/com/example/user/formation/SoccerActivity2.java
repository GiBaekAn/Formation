...
public class SoccerActivity2 extends AppCompatActivity {
    String player_name;
    String naming;
    ...
    TextView tv_player1, tv_player2, tv_player3, tv_player4, tv_player5, tv_player6, tv_player7, tv_player8, tv_player9, tv_player10, tv_player11,tv_teamName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soccer0);

        tv_teamName = (TextView) findViewById(R.id.tv_name);
        tv_teamName.setText(a.getName());

        mutebutton = (ImageView) findViewById(R.id.mutebutton4);
        mutebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (flaged == 0) {
                    stopService(new Intent(SoccerActivity2.this, MusicService.class));
                    flaged = 1;
                    mutebutton.setImageDrawable(getResources().getDrawable(R.drawable.notmute, getApplicationContext().getTheme()));
                } else {
                    startService(new Intent(SoccerActivity2.this, MusicService.class));
                    flaged = 0;
        ...
        tv_player3 = (TextView) findViewById(R.id.tv_player3);
        tv_player4 = (TextView) findViewById(R.id.tv_player4);
        tv_player5 = (TextView) findViewById(R.id.tv_player5);
        tv_player6 = (TextView) findViewById(R.id.tv_player6);
        tv_player7 = (TextView) findViewById(R.id.tv_player7);
        tv_player8 = (TextView) findViewById(R.id.tv_player8);
        tv_player9 = (TextView) findViewById(R.id.tv_player9);
        tv_player10 = (TextView) findViewById(R.id.tv_player10);
        tv_player11 = (TextView) findViewById(R.id.tv_player11);
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                for (int i = 0; i < imageViewList.size(); i++) {
                    ...
                    if ((v.getX() - imageViewList.get(i).getX()) * (v.getX() - imageViewList.get(i).getX()) +
                        ...
                        Toast.makeText(SoccerActivity2.this, "변경완료", Toast.LENGTH_SHORT).show();
    ...
    class MyListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (System.currentTimeMillis() <= btnPressTime + 1000) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(SoccerActivity2.this);
